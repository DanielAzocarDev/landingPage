  ...
  return (
    <section className=" w-full">
      <div className="w-full lg:w-10/12 flex flex-col-reverse md:flex-row md:h-[70vh] mx-auto px-3 py-12">
        <div className="flex flex-col justify-end md:justify-center gap-3 lg:gap-8 md:w-1/2  ">
          <h1 className="text-5xl font-bold tracking-wide">
            Desarrollamos soluciones digitales.
          </h1>
          <p className="text-lg font-light leading-5">
            From the Web se enfoca en crear soluciones digitales para
            necesidades de la vida real. Nuestro objetivo es ofrecer una
            perspectiva distinta a situaciones cotidianas.
          </p>
